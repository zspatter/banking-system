...
public class Account
{
    ...
    {
        if (deposit < 0)
            System.out.println("The deposit amount must be a positive value. " +
                    "Cannot complete transaction.\n");
        else
        {
            this.balance += deposit;
            System.out.printf("$%,3.2f has been deposited.\tCurrent balance: " +
    ...
    {
        if (withdraw < 0)
            System.out.println("Error: The withdrawal amount must be a " +
                    "positive value. Cannot complete transaction.\n");
        else if (withdraw > this.balance)
            System.out.println("Error: The withdrawal amount is greater " +
                    "than the account balance. Cannot complete transaction.\n");
        else
        {
