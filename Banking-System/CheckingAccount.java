...
public class CheckingAccount extends Account
{
    ...
    public CheckingAccount(String checkStyle, double minimumBalance)
    {
        ...
        if (super.getBalance() < minimumBalance)
        {
            ...
            System.out.printf("Error: The passed balance was less than the minimum balance." +
                    " The balance was assigned with the minimum balance value." +
    ...
    public void setMinimumBalance(double minimumBalance)
    {
        if (super.balance < minimumBalance)
            System.out.printf("The current balance is less than the passed minimum balance. " +
                    "Could not update the minimum balance." +
                    "\nCurrent minimum balance: $%,3.2f", getMinimumBalance());
        else
            this.minimumBalance = minimumBalance;
    }
    ...
    {
        if (withdraw < 0)
            System.out.println("Error: The withdrawal amount must be a positive value. " +
                    "Cannot complete transaction.\n");
        else if (withdraw > this.balance)
            System.out.println("Error: The withdrawal amount is greater than the account balance. " +
                    "Cannot complete transaction.\n");
        ...
        } else
        {
            ...
            System.out.printf("$%,3.2f has been withdrawn." +
